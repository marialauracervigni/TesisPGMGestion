...
namespace PGMG
{
    public class EmailService : IIdentityMessageService
    {
        ...
        public Task SendAsync(IdentityMessage message)
        {
            ...
            System.Net.NetworkCredential credentials =
                new System.Net.NetworkCredential(General.EmailEnvio,
                                                    General.contraseniaEmail);
            client.EnableSsl = true;
            client.Credentials = credentials;

            try
            {
                var mail = new MailMessage(General.EmailEnvio.Trim(),
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        internal static Task AddToCodigoTareaIdAsync(int llamadaId, string[] codigoTareaId)
        {
